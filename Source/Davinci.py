...
if __name__ == "__main__":
    ...
    # Load Data
    data = scipy.io.loadmat('../Data/Davinci.mat')
    ...
    scipy.io.savemat('../Results/Davinci_results_%s.mat' %(time.strftime('%d_%m_%Y')),
